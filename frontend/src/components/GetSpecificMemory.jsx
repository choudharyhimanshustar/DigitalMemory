    ...
    useEffect(() => {
        const fetchMemory = async () => {
            ...
            const response = await
                axios.get(`${process.env.REACT_APP_BACKEND_URL}/getSpecificMemories/${id}/${categories}`);
    ...
    return (<div>
        ...
        {memory.length > 0 ? (<div>
            ...
            <div className="BannerImgDiv">
                <img className="NoMemory" src="https://i.pinimg.com/474x/3b/fc/90/3bfc9038ed8dbe9a397df583dbafa674.jpg" />
